...
__export(src_exports, {
  parseUISpec: () => parseUISpec,
})
module.exports = __toCommonJS(src_exports)

// src/__mock__/testComponent.ts
var testComponent = `<div class="bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      precision:
        typeof (options === null || options === void 0 ? void 0 : options.precision) === 'undefined'
          ...
          : options === null || options === void 0
            ...
            : options.precision,
      offset:
        (_a = options === null || options === void 0 ? void 0 : options.offset) !== null && _a !== void 0 ? _a : false,
      local:
        (_b = options === null || options === void 0 ? void 0 : options.local) !== null && _b !== void 0 ? _b : false,
  ...
  if (check)
    return ZodAny.create().superRefine((data, ctx) => {
      ...
      if (!check(data)) {
        ...
        const _fatal =
          (_b = (_a = p.fatal) !== null && _a !== void 0 ? _a : fatal) !== null && _b !== void 0 ? _b : true
...
var zVariantBoundProperties = z.object({
...
// src/config/UISpec.ts
var zGenericProperty = z.union([z.string(), z.number(), z.boolean(), z.array(z.string())])
var zGenericObject = z.record(z.string(), zGenericProperty)
var UISpecConfigSchema = zGenericObject.nullish()
var zBaseNodeSchema = z.object({
...
var zUISpecSchema = zBaseNodeSchema.extend({
  config: UISpecConfigSchema,
  children: z.lazy(() => zUISpecSchema.array()),
})

// src/index.ts
function parseUISpec(html) {
  const parsed = zUISpecSchema.parse(html)
  return parsed
}
console.log(parseUISpec(testComponent))
