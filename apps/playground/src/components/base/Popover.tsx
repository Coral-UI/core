...
interface PopoverProps extends React.ComponentProps<typeof BasePopover.Root> {
  trigger: React.ComponentProps<typeof BasePopover.Trigger>['render']
  className?: string
}

export default function Popover({ children, trigger, className, ...props }: PopoverProps) {
  return (
    <BasePopover.Root {...props}>
      ...
      <BasePopover.Portal>
        <BasePopover.Positioner sideOffset={8}>
          <BasePopover.Popup className="origin-[var(--transform-origin)] rounded-lg bg-[canvas] px-6 py-4 text-gray-900 shadow-lg shadow-gray-200 outline outline-1 outline-gray-200 transition-[transform,scale,opacity] data-[ending-style]:scale-90 data-[ending-style]:opacity-0 data-[starting-style]:scale-90 data-[starting-style]:opacity-0 dark:shadow-none dark:-outline-offset-1 dark:outline-gray-300">
