...
export const formSchema = z.object({
  ...
  borderRadiusTopLeftUnit: unitOptions.optional(),
  borderRadiusTopRight: z.number().min(0).optional(),
  borderRadiusTopRightUnit: unitOptions.optional(),
  borderRadiusBottomRight: z.number().min(0).optional(),
  borderRadiusBottomRightUnit: unitOptions.optional(),
  borderRadiusBottomLeft: z.number().min(0).optional(),
  borderRadiusBottomLeftUnit: unitOptions.optional(),
