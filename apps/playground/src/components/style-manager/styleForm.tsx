import type { StyleFormValues } from '@/components/style-manager/formSchema'
import { CardSection } from '@/components/style-manager/components/CardSection'
import { ConditionalSection } from '@/components/style-manager/components/ConditionalSection'
import { DirectionLayoutField } from '@/components/style-manager/components/DirectionLayout'
import { ExpandableFieldGroup } from '@/components/style-manager/components/ExpandableFieldGroup'
import { OptionalSection } from '@/components/style-manager/components/OptionalSection'
import { useAppForm, withForm } from '@/components/style-manager/formContext'
import { formSchema } from '@/components/style-manager/formSchema'
import {
  AlignItemsBaseline,
  AlignItemsCenter,
  AlignItemsFlexEnd,
...
} from '@/components/style-manager/icons'
import {
  IconAlignCenter,
  IconAlignJustified,
  IconAlignLeft,
